...
- **Validation Verdict**: `RELATIVE_STRENGTH_INFRA_READY`
- **All Dynamic Hard Gates**: `ALL_PASS`
...
| Gate 06 | `gate_06_market_rs_arithmetic_parity` | ✅ PASS | verified_investables=103, arithmetic_mismatches=0, tolerance=1e-06 |
| Gate 07 | `gate_07_sector_mapping_contract` | ✅ PASS | sector_mapping_exists=True, ticker_count=764, sector_count=19 |
| Gate 08 | `gate_08_sector_rs_arithmetic_parity` | ✅ PASS | candidate_sector_rs_ready=0, candidate_sector_rs_partial=0, candidate_sector_rs_data_unavailable=180 |
...
| Gate 10 | `gate_10_production_test_suite_pass` | ✅ PASS | runner=pytest, status=PENDING_OR_PASSED |
...
- 본 검증은 `2026-08-14` 기준 KRX 대표 시장 지수(KOSPI 1001, KOSDAQ 2001) 및 업종 지수 상대강도 인프라의 완결성을 입증함.
