...
- [Phase 10B 임계값 설계·검증](../patterns/pattern_a/archive/validation/investability_threshold_design_v01.md)
- [Phase 10C 후단 통합 검증](../patterns/pattern_a/archive/validation/investability_integration_v01.md)
