...
> [Pattern A FAST point-in-time annotation checkpoint](human_point_in_time_annotation_checkpoint_v01.md)
...
둔다. `docs/patterns/pattern_a_fast/specification/lifecycle_contract.md` §21의 Skipped
