...
선행 문서: [Pattern A FAST 정의](definition_v01.md) (Phase 13A, CLOSED)
...
--------------------------------------------------------------------------------
기준 문서는 `docs/patterns/pattern_a_fast/specification/definition_v01.md`이다. Phase 13B는
...
그대로 유지한다. 상세 변경 기록은
`docs/patterns/pattern_a_fast/specification/definition_v01.md` §19 참고.
