...
- **최종 선택 권한 (Selection Authority)**: **`FINAL_STRATEGY_CONTRACT`** (`docs/patterns/pattern_a_fast/strategy/version_01/README.md` + `artifacts/patterns/pattern_a_fast/production/strategy_v01/pattern_a_fast_final_strategy_v01.json`)
...
================================================================================
5. Known Trade-offs & Risk Characteristics (알려진 위험 및 한계 - Corrected PIT Baseline)
================================================================================
