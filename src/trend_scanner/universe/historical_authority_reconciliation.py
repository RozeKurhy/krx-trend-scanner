...
# HISTORICAL_UNIVERSE_FINAL_RESIDUAL_SPAC_RESOLUTION_V01: an officially
# confirmed AS-OF-cutoff active/unterminated SPAC identity is itself
# positive NOT_COMMON authority — "not yet dissolved" is not the same as
# "insufficient evidence" (Section 8/42). These three reason codes all map
# to NOT_COMMON; none of them ever require dissolution/merger completion.
SUPPLEMENTAL_AUTHORITY_ACTIVE_SPAC_AT_HISTORICAL_CUTOFF = "SUPPLEMENTAL_AUTHORITY_ACTIVE_SPAC_AT_HISTORICAL_CUTOFF"
SUPPLEMENTAL_AUTHORITY_MERGER_WITHDRAWN_SPAC_IDENTITY_PRESERVED = "SUPPLEMENTAL_AUTHORITY_MERGER_WITHDRAWN_SPAC_IDENTITY_PRESERVED"
