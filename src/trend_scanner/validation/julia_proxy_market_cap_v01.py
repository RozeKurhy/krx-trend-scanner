...
def calculate_strategy_metrics(trades: list[StrategyTradeRecord]) -> dict[str, Any]:
    ...
    return {
        ...
        "distribution_stats": {
            "le_neg10_count": int(np.sum(returns <= -10.0)),
            "le_neg10_rate": float(np.mean(returns <= -10.0)),
            "le_neg15_count": int(np.sum(returns <= -15.0)),
            "le_neg15_rate": float(np.mean(returns <= -15.0)),
            "le_neg20_count": int(np.sum(returns <= -20.0)),
            "le_neg20_rate": float(np.mean(returns <= -20.0)),
            "le_neg30_count": int(np.sum(returns <= -30.0)),
            "le_neg30_rate": float(np.mean(returns <= -30.0)),
            "ge_pos20_count": int(np.sum(returns >= 20.0)),
            "ge_pos20_rate": float(np.mean(returns >= 20.0)),
            "ge_pos30_count": int(np.sum(returns >= 30.0)),
            "ge_pos30_rate": float(np.mean(returns >= 30.0)),
            "ge_pos50_count": int(np.sum(returns >= 50.0)),
            "ge_pos50_rate": float(np.mean(returns >= 50.0)),
            "ge_pos100_count": int(np.sum(returns >= 100.0)),
            "ge_pos100_rate": float(np.mean(returns >= 100.0)),
        },
        "mae_stats": {
