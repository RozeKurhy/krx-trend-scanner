...
_SECTOR_MEMBERSHIP_AUTHORITY = "KRX_DATA_MARKETPLACE_INDEX_CONSTITUENTS"
_SECTOR_MEMBERSHIP_SOURCE_NAME = "KRX Data Marketplace official index constituents"
_SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS = ("KRX Data Marketplace official index constituents CSV",)
...
AUTHORITY_FIELDS: tuple[AuthorityFieldContract, ...] = (
    ...
    _field("membership.effective_date", "SectorMembershipStore", "effective_date", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.AUTHORITATIVE, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "effective_date", "EXACT_DATE_SECTOR_MEMBERSHIP_SNAPSHOT", "TEMPORAL_KEY", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.ticker", "SectorMembershipStore", "ticker", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.AUTHORITATIVE, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "종목코드", "KRX_TICKER", "IDENTITY_KEY", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.RESPONSE_FIELD),
    _field("membership.sector_code", "SectorMembershipStore", "sector_code", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.AUTHORITATIVE, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "sector_code", "CANONICAL_NATIVE_SECTOR_CODE", "AUTHORITATIVE_SOURCE", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.market", "SectorMembershipStore", "market", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.AUTHORITATIVE, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "market", "MARKET_NAMESPACE", "AUTHORITATIVE_SOURCE", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.resolution_status", "SectorMembershipStore", "resolution_status", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.DERIVED, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "resolution_status", "MAPPED_AGGREGATE_ONLY_UNMAPPED", "STATE_METADATA", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.policy_version", "SectorMembershipStore", "policy_version", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.DERIVED, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "policy_version", "MOST_SPECIFIC_NATIVE_SECTOR_POLICY", "PROVENANCE_METADATA", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.source_authority", "SectorMembershipStore", "source_authority", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.DERIVED, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "source_authority", "SOURCE_AUTHORITY_IDENTIFIER", "PROVENANCE_METADATA", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
    _field("membership.source_artifact_sha256", "SectorMembershipStore", "source_artifact_sha256", _SECTOR_MEMBERSHIP_AUTHORITY, AuthorityType.DERIVED, _SECTOR_MEMBERSHIP_SOURCE_NAME, _SECTOR_MEMBERSHIP_SOURCE_ENDPOINTS, "source_artifact_sha256", "SOURCE_ARTIFACT_SHA256", "PROVENANCE_METADATA", "SECTOR_MEMBERSHIP_STORE_V01", provenance_origin=ProvenanceOrigin.PROVENANCE_METADATA),
...
STORE_CONTRACTS: tuple[StoreContract, ...] = (
    ...
    StoreContract("SectorMembershipStore", "Exact-date KRX canonical ticker to sector membership snapshots", "SECTOR_MEMBERSHIP_STORE_V01", ("ticker", "market", "effective_date", "sector_code", "sector_name", "resolution_status", "policy_version", "source_authority", "source_artifact_sha256"), ("ticker", "market", "effective_date", "sector_code", "resolution_status"), "Multiple approved exact-date snapshots; preserve prior snapshots", True, "Append approved exact-date snapshots; preserve prior snapshots; no carry-forward/back-application"),
...
LAYER_REGISTRY: tuple[LayerContract, ...] = (
    ...
    _layer("SECTOR_MEMBERSHIP", "Ticker to sector membership exact-date snapshots", "KRX Data Marketplace official index constituents", "SectorMembershipStore exact-date Marketplace snapshots", "KRX Data Marketplace official index constituents CSV", "SectorMembershipStore", "SectorMembershipStore", "Approved exact effective-date snapshot", OperationalStatus.ACTIVE, MigrationStatus.MIGRATED),
    ...
    _layer("SECTOR_RS", "Sector relative strength", "Derived from stock prices + exact-date SectorMembershipStore + KRX native sector index", "Exact-date SectorMembershipStore + KRX native sector index", "Exact-date SectorMembershipStore + KRX native sector index", "Existing analytics", "Analytics output", "As-of session with exact-date membership snapshot", OperationalStatus.ACTIVE, MigrationStatus.MIGRATED),
