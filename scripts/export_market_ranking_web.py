...
def _project_item(index_item: dict[str, Any], report: dict[str, Any], path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "stock_return_2w": market_strength.get("stock_return_2w"),
        "stock_return_1m": market_strength.get("stock_return_1m"),
        "stock_return_3m": market_strength.get("stock_return_3m"),
        "stock_return_6m": market_strength.get("stock_return_6m"),
        "stock_return_12m": market_strength.get("stock_return_12m"),
