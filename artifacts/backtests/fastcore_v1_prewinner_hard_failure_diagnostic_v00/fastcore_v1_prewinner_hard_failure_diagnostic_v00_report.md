# FASTCORE V1 PRE-WINNER HARD FAILURE DIAGNOSTIC V00
...
- CLOSE — ALL_973 NEVER_WINNER: p10 -74.118515%, p25 -60.757216%, median -46.663824%, p75 -30.547127%, p90 -18.900116%, worst -99.931436%, mean -46.527185%.
- LOW — ALL_973 NEVER_WINNER: p10 -75.271228%, p25 -61.948004%, median -48.487329%, p75 -32.846332%, p90 -20.322380%, worst -99.934354%, mean -47.838565%.
- Loss Guard 590건 중 NEVER_WINNER 203건: CLOSE — LOSS_GUARD_590 NEVER_WINNER: p10 -75.221314%, p25 -61.407054%, median -48.146067%, p75 -33.902043%, p90 -25.226220%, worst -99.931436%, mean -48.977295%.
- Loss Guard NEVER_WINNER LOW — LOSS_GUARD_590 NEVER_WINNER: p10 -76.174147%, p25 -62.542991%, median -49.705882%, p75 -34.991245%, p90 -26.419404%, worst -99.934354%, mean -50.277217%.

### Q3. 두 분포가 가장 크게 갈라지는 구간

- 전체 close bin에서 `-20% to > -25%`는 RECOVERY 56건/NEVER_WINNER 10건, `-25% to > -30%`는 35건/20건, `-30% to > -35%`는 23건/17건이야.
- Loss Guard close bin에서는 같은 구간이 각각 55/9, 33/20, 23/17건이야.
- 따라서 분포 분리는 -20%~-30%부터 눈에 띄게 커지고, -60% 이하에서는 NEVER_WINNER가 지배적이지만 그 깊은 threshold는 recovery 보호와 capture를 함께 크게 잃어 후보 선정에는 부적합해.
...
| -50% to > -55% | 34/3.494347% | 13/1.336074% | 21/2.158273% | 38.235294% |
| -55% to > -60% | 31/3.186023% | 7/0.719424% | 24/2.466598% | 22.580645% |
| <= -60% | 75/7.708119% | 13/1.336074% | 62/6.372045% | 17.333333% |
...
| -50% to > -55% | 33/5.593220% | 12/2.033898% | 21/3.559322% | 36.363636% |
| -55% to > -60% | 26/4.406780% | 6/1.016949% | 20/3.389831% | 23.076923% |
| <= -60% | 67/11.355932% | 11/1.864407% | 56/9.491525% | 16.417910% |
...
| -55% | 20/2.713704% | 86/36.440678% | 674/69.270298% | 7.678407% | 8.840000% | 242/129/49/24 | 194/162/135/109/6 | 245.535457d | -0.987934% |
| -60% | 13/1.763908% | 62/26.271186% | 680/69.886948% | 8.050545% | 9.070000% | 243/130/49/24 | 186/152/125/91/71 | 264.453237d | -0.615796% |

### Q6. V1 backtest candidate threshold

**V1 backtest candidate threshold: -30%**. 이 지점은 RECOVERY kill 118건/16.010855%, NEVER_WINNER capture 179건/75.847458%, hypothetical positive rate 60.226105%, mean 5.261881%를 보인다. -25%에서 더 깊어질 때의 capture 감소와 -35%에서의 mean 정체가 만나는 elbow로 선택한 분석 후보이며, 최대 평균수익률을 고른 것이 아니고 production threshold 확정도 아니다. 인접 후보는 -25%, -35%다.
...
| -55% | NEVER_WINNER | 86 | -56.171279% | -55.925000% | 4.771395% | 8.513953% |
| -60% | RECOVERY | 13 | -60.883077% | -60.670000% | -73.551538% | 51.450000% |
| -60% | NEVER_WINNER | 62 | -61.180323% | -60.925000% | 5.758065% | 9.253710% |
...
상세 산출물 절대 경로: `/Users/june/Documents/projects/krx-trend-scanner/artifacts/backtests/fastcore_v1_prewinner_hard_failure_diagnostic_v00`
