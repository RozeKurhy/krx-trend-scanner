...
|---|:---:|:---:|:---:|
| **Return <= -30% 발생 건수 (비율)** | 72건 (13.02%) | 11건 (1.99%) | **-61건** |
| **Return <= -20% 발생 건수 (비율)** | 106건 (19.17%) | 33건 (5.97%) | **-73건** |
| **Return <= -10% 발생 건수 (비율)** | 163건 (29.48%) | 313건 (56.6%) | **150건** |
| **최악 손실률 (Worst Return)** | -86.26% | -54.43% | **+31.83%p** |
...
| **Return >= +100% Winner 수 (비율)** | 51건 (9.22%) | 7.41% (41건) | 41건 (7.41%) |
